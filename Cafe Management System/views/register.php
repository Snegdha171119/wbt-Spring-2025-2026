...
<title>Register &mdash; Cafe Management</title>
...
<div class="auth-shell">
    <div class="auth-side">
        ...
        <h1>Join as a Staff</h1>
        <p>Create your account to start managing orders in the cafe system.</p>
        <ul class="feature-list">
            <li>&#10003; Add and edit orders</li>
    ...
    <div class="auth-form-wrap">
        <div class="auth-card">
            ...
            <p class="muted">Register as a staff</p>
