...
<title>Login &mdash; Cafe Management</title>
...
<div class="auth-shell">
    <div class="auth-side">
        ...
        <p>Manage staffs and orders in one place. Sign in to access your dashboard.</p>
        <ul class="feature-list">
            <li>&#10003; Admin manages staffs</li>
            <li>&#10003; Staffs manage orders</li>
    ...
    <div class="auth-form-wrap">
        <div class="auth-card">
            ...
            <p class="auth-foot">Don't have an account?
                <a href="index.php?page=register">Register as Staffs</a>
            </p>
