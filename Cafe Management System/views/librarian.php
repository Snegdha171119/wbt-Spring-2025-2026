...
<title>Staff Dashboard &mdash; Cafe Management</title>
...
<main class="main-content">
    <div class="page-header">
        <div>
            ...
            <p class="page-sub">Add, edit, search and remove orders in the catalog</p>
        </div>
    </div>

    <?php if (isset($_GET['msg'])): ?>
        <?php $messages = ['added' => 'Order added successfully.',
    ...
    <div class="card form-card">
        <h3 class="card-title">
            <?= $isEdit ? '&#9998; Edit Order (#' . intval($editing['id']) . ')' : '+ Add New Order' ?>
        </h3>
        <form method="POST"
            ...
            <div class="field-row">
                <div class="field">
                    ...
                    <input type="text" id="title" name="title"
                           ...
                           placeholder="e.g. Fast Food,Coffee,Juice" required>
                </div>
                <div class="field">
                    <label for="author">Food Name</label>
        ...
        <div class="card-toolbar">
            <div class="search-wrap">
                ...
                <input type="text" id="searchInput" class="search-input"
                       placeholder="Search by Food category  or Food name...">
            </div>
